...
public class MemberController {
    ...
    */
    ...
    public ApiResponseDTO<?> viewMemberInfo() {
        MemberModifyDTO memberModifyDTO = null;
        try {
            Member member = (Member) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
            memberModifyDTO = memberService.getMemberInfo(member.getMemberId());
    ...
    public ApiResponseDTO<?> modifyMemberInfo(@RequestBody MemberModifyDTO memberDto) {
        log.info("memberDto = {}", memberDto);
        Member member = null;
        try {
            Member contextMember = (Member) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
            member = memberService.modifyMemberInfo(contextMember.getMemberId(), memberDto);
        } catch (NoSuchElementException exception) {
    ...
    public ApiResponseDTO<?> uploadProfileImage(MemberProfileImageDTO imageDTO) {
        ...
        try {
            ...
            imageURL = firebaseService.saveFile(profileImage);  // UUID + 원본파일명 형태로 저장됨
    ...
    public ApiResponseDTO<?> sendPasswordEmail(@RequestBody MemberEmailDTO emailDTO) {
        try {
            ...
            sb.append("https://hj-vital-routes.vercel.app/login/reset-password/");
            sb.append(token);
